...
class DataHubUploader:
    ...
    def upload_file(self, local_path, datahub_path: str, is_versioned: bool = False) -> None:
        """
        Upload a single file to DataHub.
        
        Args:
            local_path: Path to local file
            datahub_path: Target path in DataHub (e.g. 'Project/Study/Results/')
            is_versioned: Whether to upload as a versioned file
        """
        self.authenticate()
    ...
    def upload_directory(self, local_dir: Path, datahub_path: str, 
                        pattern: str = "*", is_versioned: bool = False) -> int:
        """
        ...
        Args:
            ...
            is_versioned: Whether to upload as versioned files
